...
//     const sma = new SimpleMovingAverage(stocks, 12, 'closingPrice', 'SMA');
...
//     expect(stocksWithMA[11].SMA12).to.be.not.equal(0);
//     expect(stocksWithMA[stocks.length - 1].SMA12).to.be.not.equal(0);
//   });

//   it('should be able to compute for moving average when days is equal to computed average', () => {
//     const sma = new SimpleMovingAverage(stocks, 20, 'closingPrice', 'SMA');
//     const stocksWithMA = sma.compute();
